...
class QualityMidcapSignal:
    """Mid-cap variant: adds earnings_yield for valuation dimension."""

    name = "quality_midcap"
    description = "Quality + value: ROE, ROIC, ROA, low debt, R&D, earnings yield"
